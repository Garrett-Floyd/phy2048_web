...
},
{
  ...
  "number": "3.1.3",
  "title": "",
  "body": "  The average speed ( ) of an object over a period of time is where is the total distance traveled.   "
},
{
  "id": "def-avg-acc",
  "level": "2",
...
},
{
  ...
  "body": " Integral Equations of Motion         Recall from equation that Integrating both sides with respect to time yields We now use the chain rule on the right hand side of the equation to transform it from an integral with respect to to an integral with respect to . This gives            Recall from equation that Integrating both sides with respect to time yields We now use the chain rule on the right hand side of the equation to transform it from an integral with respect to to an integral with respect to . This gives     For one dimensional motion along the x-axis the distance travelled is equal to In other words, distance is the integral of speed (not velocity)!  "
},
{
  "id": "thm-1d-int-eq-x",
  "level": "2",
  ...
  "number": "3.2.1",
  "title": "",
  "body": "       Recall from equation that Integrating both sides with respect to time yields We now use the chain rule on the right hand side of the equation to transform it from an integral with respect to to an integral with respect to . This gives    "
},
{
  "id": "thm-1d-int-eq-vx",
  "level": "2",
...
{
  "id": "thm-comps-of-inst-vel",
  "level": "2",
  "url": "sec-2d-pos-vel-acc.html#thm-comps-of-inst-vel",
  "type": "Theorem",
  "number": "6.1.4",
  "title": "",
  "body": "  The x,y, and z components of the velocity are     Velocity is We can also write the velocity out in terms of its components Setting these equal to each other we get Since vectors are equal if and only if their components are equal, the x-component of the velocity is the y-component of velocity is and the z-component of velocity is    "
},
{
...
{
  "id": "thm-comps-of-inst-acc",
  "level": "2",
  "url": "sec-2d-pos-vel-acc.html#thm-comps-of-inst-acc",
  "type": "Theorem",
  "number": "6.1.6",
  "title": "",
  "body": "  The x,y, and z components of the acceleration are     Acceleration is We can also write the velocity out in terms of its components Setting these equal to each other we get Since vectors are equal if and only if their components are equal, the x-component of the acceleration is the y-component of velocity is and the z-component of velocity is    "
},
{
  ...
  "number": "6.2",
  "title": "Integral Equations of Motion",
  "body": " Integral Equations of Motion         The proof for each component is the same as , if we change all the x's to the coordinate we want.           The proof for each component is the same as , if we change all the x's to the coordinate we want.    "
},
{
  "id": "thm-r-int-eq",
  "level": "2",
  ...
  "number": "6.2.1",
  "title": "",
  "body": "       The proof for each component is the same as , if we change all the x's to the coordinate we want.   "
},
{
  "id": "thm-v-int-eq",
  "level": "2",
...
},
{
  "id": "thm-rel-vel",
  "level": "2",
  "url": "sec-rel-vel-calc.html#thm-rel-vel",
  "type": "Theorem",
  "number": "8.3.2",
  "title": "",
...
{
  "id": "sec-pulley-probs-general",
  "level": "1",
  "url": "sec-pulley-probs-general.html",
  "type": "Section",
  "number": "12.3",
  "title": "Pulley Problems in General",
  "body": " Pulley Problems in General  When pulleys or the objects they're connected to move relative to each other we will usually need an equation of constraint to solve the problem. An equation of constraint is a mathematical formula that defines the physical or geometric limitations placed on a system. When objects that are connected by a taut string move, we use an equation of constraint to encode the requirment that the objects must move in a way that keeps the length of the string constant. The equation of constraint for the string usually expresses the length of the string in terms of the coordinates of the attached objects. If equations of constraint seem confusing at this point, know that it's easier to understand the concept through examples.  "
},
{
  "id": "sec-pulley-probs-general-2",
  "level": "2",
  "url": "sec-pulley-probs-general.html#sec-pulley-probs-general-2",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
},
{
  ...
  "number": "15.1",
  "title": "Work",
  "body": " Work   This chapter and the next explores mechanical energy and related concepts. Before beginning it will be helpful to give an intuitive but unrigourous, imprecise, and slightly incorrect overview of energy. Unrigourously, energy is a quantitative property of a system of one or more objects describing its ability to cause change. Energy can have many different forms. Some examples are electrical, chemical, and gravitational. A useful analogy for energy is money. Money lets you buy stuff and can be in many different accounts. Energy lets you do stuff and can be in many different forms. The total energy of a system is like the system's \"net worth\".  One important energy \"account\" is kinetic energy. The kinetic energy (often written as or ) is the energy an object has due to its motion. Mathimatically, where is mass of the object and is the speed of the object. In addition to the kinetic energy \"account\", every force that satisfies some special conditions (which we will discuss later) also has an energy account. For example, the gravitational energy \"account\" is the \"account\" associated with the gravitational force.  In this section we will explore the concept of work in physics. Work ( ) on a system of one or more objects is the energy transferred to that systems by means of a force acting on the object. Energy transferred to the object is positive work, and energy transferred from the object is negative work. Continuing the money analogy, work is analogous to transferring money between accounts. Positive work done by a force transfers energy from the account associated with that force into the object's kinetic energy account Negative work done by a force transfers energy out of the object's kinetic energy account and into the account associated with that force.    Work From a Single Force    The work done on an object by a constant force over a straight line displacement is defined as where is the angle between and .    The units of work are Newtons times meters ( ) or Joules ( ). If the object's displacement isn't a straight line or the force isn't constant the expression above breaks down.  However, we can use calculus to come up with a more general expression. Assume an object is moved by a variable force over a complex path or contour ( ) from some initial point to some final point.  We can express the displacement vector of the object after it has moved along the contour as a sum of displacement vectors that approximate the objects path. Taking the limit as the number of displacement vectors used to approximate the path goes to infinity gives an infinite sum of infinitesmal displacement vectors. Because the length of each of these displacement vectors is so small, we can approximate them as straight line displacements. Similiarly because a realistic force can't substantially vary over such a small distance we can approximate the force over each infinitesmal displacement as constant. Then the infinitesmal amount of work ( ) done over the infinitesmal displacement ( ) is To get the total work ( ) done over the contour, we integrate the work done over all the infinitesmal displacements. One way to evaluate this integral is to change it to an integral over time. By the chain rule Therefore, Then we get     Net Work  The work done by all the forces acting on the object as it moves along the path is known as the net work . The net work is given by Because the path is the same for each force (object only follows one path), we can bring the summation into the integral. Noting that we get    "
},
{
  "id": "def-const-force-straight-disp-work",
  "level": "2",
  "url": "sec-work.html#def-const-force-straight-disp-work",
  "type": "Definition",
  "number": "15.1.1",
  "title": "",
  "body": "  The work done on an object by a constant force over a straight line displacement is defined as where is the angle between and .   "
},
{
  "id": "subsec-calc-work-from-mult-forces-2",
  "level": "2",
  "url": "sec-work.html#subsec-calc-work-from-mult-forces-2",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "net work "
...
{
  "id": "sec-calc-momentum-impulse",
  "level": "1",
  "url": "sec-calc-momentum-impulse.html",
  "type": "Section",
  "number": "17.1",
...
{
  "id": "sec-calc-momentum-impulse-2",
  "level": "2",
  "url": "sec-calc-momentum-impulse.html#sec-calc-momentum-impulse-2",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "momentum "
...
{
  "id": "sec-calc-momentum-impulse-3",
  "level": "2",
  "url": "sec-calc-momentum-impulse.html#sec-calc-momentum-impulse-3",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "net impulse "
...
{
  "id": "exercises-sec-calc-impulse-1",
  "level": "2",
  "url": "sec-calc-momentum-impulse.html#exercises-sec-calc-impulse-1",
  "type": "Exercise",
  "number": "17.1.1",
...
{
  "id": "exercises-sec-calc-impulse-2",
  "level": "2",
  "url": "sec-calc-momentum-impulse.html#exercises-sec-calc-impulse-2",
  "type": "Exercise",
  "number": "17.1.2",
  "title": "",
...
{
  "id": "exercises-sec-calc-impulse-3",
  "level": "2",
  "url": "sec-calc-momentum-impulse.html#exercises-sec-calc-impulse-3",
  "type": "Exercise",
  "number": "17.1.3",
  "title": "",
...
{
  "id": "sec-conserv-momentum-6",
  "level": "2",
  "url": "sec-conserv-momentum.html#sec-conserv-momentum-6",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
...
{
  "id": "exercises-sec-collisions-1",
  "level": "2",
  "url": "sec-collisions.html#exercises-sec-collisions-1",
  "type": "Exercise",
  "number": "17.3.4.1",
...
{
  "id": "exercises-sec-collisions-2",
  "level": "2",
  "url": "sec-collisions.html#exercises-sec-collisions-2",
  "type": "Exercise",
  "number": "17.3.4.2",
  "title": "",
...
{
  "id": "exercises-sec-collisions-3",
  "level": "2",
  "url": "sec-collisions.html#exercises-sec-collisions-3",
  "type": "Exercise",
  "number": "17.3.4.3",
  "title": "",
...
{
  "id": "exercises-sec-collisions-4",
  "level": "2",
  "url": "sec-collisions.html#exercises-sec-collisions-4",
  "type": "Exercise",
  "number": "17.3.4.4",
  "title": "",
...
{
  "id": "exercises-sec-collisions-5",
  "level": "2",
  "url": "sec-collisions.html#exercises-sec-collisions-5",
  "type": "Exercise",
  "number": "17.3.4.5",
  "title": "",
...
{
  "id": "exercises-sec-collisions-6",
  "level": "2",
  "url": "sec-collisions.html#exercises-sec-collisions-6",
  "type": "Exercise",
  "number": "17.3.4.6",
  "title": "",
...
{
  "id": "exercises-sec-collisions-7",
  "level": "2",
  "url": "sec-collisions.html#exercises-sec-collisions-7",
  "type": "Exercise",
  "number": "17.3.4.7",
  "title": "",
...
{
  "id": "exercises-sec-collisions-8",
  "level": "2",
  "url": "sec-collisions.html#exercises-sec-collisions-8",
  "type": "Exercise",
  "number": "17.3.4.8",
  "title": "",
...
{
  "id": "exercises-sec-collisions-9",
  "level": "2",
  "url": "sec-collisions.html#exercises-sec-collisions-9",
  "type": "Exercise",
  "number": "17.3.4.9",
  "title": "",
...
{
  "id": "exercises-sec-collisions-10",
  "level": "2",
  "url": "sec-collisions.html#exercises-sec-collisions-10",
  "type": "Exercise",
  "number": "17.3.4.10",
  "title": "",
...
{
  "id": "exercises-sec-collisions-11",
  "level": "2",
  "url": "sec-collisions.html#exercises-sec-collisions-11",
  "type": "Exercise",
  "number": "17.3.4.11",
  "title": "",
...
{
  "id": "exercises-sec-collisions-12",
  "level": "2",
  "url": "sec-collisions.html#exercises-sec-collisions-12",
  "type": "Exercise",
  "number": "17.3.4.12",
  "title": "",
...
},
{
  "id": "def-ang-vel-z",
  "level": "2",
  "url": "sec-rot-kin.html#def-ang-vel-z",
  "type": "Definition",
  "number": "18.1.3",
  "title": "",
  "body": "  We define the z-component of the angular velocity as    "
},
{
  "id": "def-ang-acc-z",
  "level": "2",
  "url": "sec-rot-kin.html#def-ang-acc-z",
  "type": "Definition",
  "number": "18.1.4",
  "title": "",
  "body": "  Similarly we define the z-component of the angular acceleration as    "
},
{
  ...
  "number": "18.1.5",
  "title": "",
  "body": "  If is constant then     Evaluating equation with constant gives the desired result.    If the z-component of the angular acceleration is constant then by we have Rearranging, we get    "
},
{
...
{
  "id": "thm-calc-vel-circ-motion",
  "level": "2",
  "url": "sec-circ-motion.html#thm-calc-vel-circ-motion",
  "type": "Theorem",
  "number": "18.2.4",
  "title": "",
